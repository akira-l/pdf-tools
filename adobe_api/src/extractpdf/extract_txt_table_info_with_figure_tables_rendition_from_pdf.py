...
def parse_args():
    ...
    parser.add_argument('--file_path', dest='file_path',
                        default='', type=str)
    parser.add_argument('--extracted_path', dest='out_path',
                        default='', type=str)
...
if __name__ == '__main__':
    ...
    try:
        ...
        source = FileRef.create_from_local_file(os.path.join(base_path, args.file_path)) 
        ...
        result.save_as(os.path.join(base_path, args.out_path)) 
